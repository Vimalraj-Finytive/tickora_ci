...
public interface UserAdapter {
    ...
    List<UserResponse> findByOrganizationId(String orgId, int hierarchyLevel);
    ...
    List<GroupsData> getGroupData(String orgId);
    ...
    List<GroupDto> getUserGroups(Long userId, String orgId);
    List<UserGroupEntity> getGroupMembersByGroupId(Long groupId, String orgId);
    List<UserEntity> getUsersByIds(List<Long> userIds, String orgId);
    Optional<UserEntity> findByMobileNumber(String mobileNumber);
    List<UserEntity> getAllUsers(String orgId, Long userIdFromToken, int hierarchyLevel);
    ...
    List<UserGroupEntity> findUserByOrganizationIdAndUserId(String organizationId, Long userId);
    ...
    UserEntity findUserByOrgIdAndUserId(String orgId, Long userId);
