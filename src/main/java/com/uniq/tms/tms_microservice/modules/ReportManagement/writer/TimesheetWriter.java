...
public class TimesheetWriter {
    ...
    public TimesheetWriter(ReportStyleUtil reportStyleUtil) {
        this.reportStyleUtil = reportStyleUtil;
    }

    public void writeDayCsv(List<UserTimesheetResponseDto> data, File file) throws Exception {
        Files.write(file.toPath(), exportTimesheetDayCsv(data));
    }

    public void writeDayXlsx(List<UserTimesheetResponseDto> data, File file) throws Exception {
        Files.write(file.toPath(), exportTimesheetDayXlsx(data));
    }

    public void writeWeekCsv(List<UserTimesheetResponseDto> data, File file) throws Exception {
        Files.write(file.toPath(), exportTimesheetWeekCsv(data));
    }

    public void writeWeekXlsx(List<UserTimesheetResponseDto> data, File file) throws Exception {
        Files.write(file.toPath(), exportTimesheetWeekXlsx(data));
    }
     ...
     */
    public byte[] exportTimesheetDayCsv(List<UserTimesheetResponseDto> timesheet) {
