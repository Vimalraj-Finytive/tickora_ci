package com.uniq.tms.tms_microservice.modules.authenticationManagement.services.impl;
...
import com.uniq.tms.tms_microservice.shared.security.cache.OtpFallbackCache;
...
import com.uniq.tms.tms_microservice.modules.organizationManagement.dto.OrganizationDropdownDto;
...
import com.uniq.tms.tms_microservice.modules.organizationManagement.enums.OrganizationSizeRangeEnum;
...
import com.uniq.tms.tms_microservice.shared.helper.TenantResolverHelper;
...
import com.uniq.tms.tms_microservice.modules.authenticationManagement.services.NettyfishService;
import com.uniq.tms.tms_microservice.shared.util.CacheKeyUtil;
import com.uniq.tms.tms_microservice.shared.util.PasswordUtil;
...
public class AuthServiceImpl implements AuthService {
    ...
    public ResponseEntity<ApiResponse> authenticateUserByEmail(String email, String password,
        ...
        String key = organizationCacheService.getPrivilegeKey(PrivilegeConstants.LOGIN_VIA_EMAIL);
    ...
    public ResponseEntity<ApiResponse> sendOtp(String mobile) {
        ...
        if (!isParent) {
            String key = organizationCacheService.getPrivilegeKey(PrivilegeConstants.LOGIN_VIA_MOBILE);
