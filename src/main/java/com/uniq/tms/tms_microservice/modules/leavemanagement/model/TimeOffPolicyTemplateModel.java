...
public class TimeOffPolicyTemplateModel {
    private String policyCode;
    private String policyName;
    private Integer entitledUnits;
    private GenderApplicability genderApplicability;

    public TimeOffPolicyTemplateModel(String policyCode, String policyName, Integer entitledUnits, GenderApplicability genderApplicability) {
