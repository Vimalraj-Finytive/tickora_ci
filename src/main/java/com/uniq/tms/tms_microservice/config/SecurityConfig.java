    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll()
                        .requestMatchers("/tms/login", "/tms/logout", "/tms/validate-email", "/tms/reset-password").permitAll()
                        .requestMatchers("/tms/admin/**").hasAnyAuthority("admin", "SuperAdmin") // Corrected Role Check
