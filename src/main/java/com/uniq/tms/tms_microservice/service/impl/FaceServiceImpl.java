...
import com.uniq.tms.tms_microservice.mapper.UserFaceEntityMapper;
import com.uniq.tms.tms_microservice.model.TimesheetHistory;
import com.uniq.tms.tms_microservice.service.FaceService;
...
public class FaceServiceImpl implements FaceService {
    ...
    public FaceServiceImpl(UserAdapter userAdapter, RestTemplate restTemplate, UserFaceEntityMapper userFaceEntityMapper, TimesheetService timesheetService, TimesheetEntityMapper timesheetEntityMapper) {
    ...
    public ApiResponse<RegisterDto> UserFaceRegister(RegisterDto registerDto, String orgSchema) {
        ...
        try {
            ...
            if (response.getStatusCode() == HttpStatus.CREATED) {
                ...
                userAdapter.saveUserFace(userFaceEntity);
    ...
    public ApiResponse<ClockInOutRequestDto> clockInOutUser(ClockInOutRequestDto registerDto, String orgSchema) {
        ...
        try {
            ...
            UserFaceEntity userFace = userAdapter.findUserEmbeddingsById(registerDto.getUserId())
