...
public interface UserService {
    ...
    List<Group> getAllGroup(Long orgId);
    List<Location> getAllLocation(Long orgId);
    ApiResponse bulkCreateUsers(MultipartFile file, Long orgId, Long userId);
    ApiResponse createUser(UserDto userDto,SecondaryDetailsDto secondaryDetailsDto, Long organizationId);
